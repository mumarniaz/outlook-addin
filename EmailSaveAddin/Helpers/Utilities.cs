...
namespace EmailSaveAddin.Helpers
{
    public class Utilities
    {
        ...
        private static double TaskPaneWidthFactor = 0.18; //380 (ideal width) / 1920 (perfect for ideal width) = 0.1979 | Changed to .22 to be a bit larger for Hannon
        private static double ScrollViewerHeightFactor = 0.18;
